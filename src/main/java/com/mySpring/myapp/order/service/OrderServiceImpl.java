...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public int addOrder(OrderVO order) throws DataAccessException {
        return orderDAO.insertOrder(order);
    }

    @Override
    public int removeOrder(String order_no) throws DataAccessException {
        return orderDAO.deleteOrder(order_no);
    }
    
    @Override
    public int removeOrderManager(int order_no) throws DataAccessException {
        return orderDAO.deleteOrderManager(order_no);
    }
