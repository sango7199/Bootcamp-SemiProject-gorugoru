    ...
    <div class="content">
        ...
        <section class="image-grid">
            <div class="grid-item">
                ...
                <img src="${contextPath}/resources/images/thumbnail_01.jpg" alt="사과">
            </div>
            <div class="grid-item">
                <div class="product-info">
                ...
                <img src="${contextPath}/resources/images/thumbnail_02.jpg" alt="바나나">
            </div>
            <div class="grid-item">
                <div class="product-info">
                ...
                <img src="${contextPath}/resources/images/thumbnail_03.jpg" alt="감자">
            </div>
        </section>
    </div>
