...
<body>
	...
	<div class="content">
		...
		<div class="breadcrumb">
			<a href="${contextPath}/member/listMembers.do">멤버 관리</a> > <a href="${contextPath}/member/listMembers.do">멤버 리스트</a> > 멤버 상세
		</div>
		...
		<div class="member-detail">
			<div class="member-detail-left">
				...
				<button>멤버 정보 수정</button>
				<a href="${contextPath}/member/removeMember.do?id=${member.id}"><button>탈퇴</button></a>
			</div>
		</div>
	</div>
